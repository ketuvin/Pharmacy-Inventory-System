        ...
        'columns' => [
            ...
            [
                ...
                'export' => function ($url, $model) {
                    return Html::a('View', ['reports/view-withdrawal-report-pdf', 'id' => $model->withdraw_reportno], ['class' => 'btn btn-primary', 'target'=>'_blank', 'data-toggle'=>'tooltip', 'title'=>'Download as PDF','data-pjax' => 0]);
                    },
