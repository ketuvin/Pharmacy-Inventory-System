        ...
        'columns' => [
            ...
            [
                ...
                'export' => function ($url, $model) {
                    return Html::a('Export', ['reports/generate-withdrawals-report', 'start_date' => $model->start_date, 'end_date' => $model->end_date], ['class' => 'btn btn-danger', 'target'=>'_blank', 'data-toggle'=>'tooltip', 'title'=>'Download as PDF']);
                    },
